Huffman.Tree = function(_a, _b) {
  this.root = _a;
  this.frequencyTable = _b;
...
Huffman.Tree.decodeTree = function(data,frequencyTable) {
  return new Huffman.Tree(Huffman.Tree.parseNode(data), frequencyTable);
};
